...
public sealed class TeamTime
{
    ...
    /// <summary>
    ///     If the team follows summer time (if true, the time-of-day is constant in the local timezone regardless of UTC
    ///     offset).
    /// </summary>
    /// <remarks>
    ///     <list type="table">
    ...
    ///             <term>False</term>
    ///             <description>
    ///                 The team maintains the same offset relative to UTC (the time-of-day shifts in the local
    ///                 timezone).
    ///             </description>
    ///         </item>
    ///     </list>
...
)
{
    public TeamMember(Domain.TeamMembership member) : this(
        ...
        member.Player.DiscordAccountName,
        member.Player.GameAccount,
        member.Player.DiscordAccountId)
    {
    }
}
